...
if page ==  "Notizie generali":  
    ...
    if selected == "Calcola l'ipotenusa":
        cateto_1 = st.number_input("Inserisci il valore del primo cateto", min_value=0, max_value=None, value=0.0,label_visibility="visible")
        cateto_2 = st.number_input("Inserisci il valore del secondo cateto", min_value=0, max_value=None, value=0.0,label_visibility="visible")
        ...
        cateto_1 = st.number_input("Inserisci il valore di un cateto", min_value=0, max_value=None, value=0.0,label_visibility="visible")
        ipotenusa = st.number_input("Inserisci il valore dell' ipotenusa", min_value=0, max_value=None, value=0.0,label_visibility="visible")
